...
router.get('/page/:page', async (req, res) => {
    ...
    try {
        ...
        link = {
                endpoint: $(e).find('.thumb > a').attr('href').replace('https://rajahentai.xyz/', ''),
...
router.get('/rekomendasi', async (req, res) => {
    ...
    try {
        ...
        $(element).find('.recomx > ul > li > .zeeb').each((i, e) => {
            ...
            link = {
                endpoint: $(e).find('a').attr('href').replace('https://rajahentai.xyz/', ''),
    ...
    try {
        ...
        $(element).find('a').each((i, e) => {
            ...
            link = {
                ...
                url: $(e).attr('href').replace('https://rajahentai.xyz/', '')
            }
